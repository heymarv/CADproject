                ...
                <div class="container">
                    <div class="row">
                        <div class="main_home text-center">
                            <div class="home_text">
                                <h4 class="text-white text-uppercase">a new tech boutique</h4>
                                <h1 class="text-white text-uppercase">assimilate information at your fingertips.</h1>

                                <div class="separator"></div>

                                <h5 class=" text-uppercase text-white"><em>We believe in merging tech and knowledge as a tool to study faster, more efficiently and accurately.</em></h5>
                            </div>
                        </div>
                    </div><!--End off row-->
                        ...
                        <div class="main_feature">
                            ...
                            <div class="col-md-6 m-top-120">
                                ...
                                <div class="head_title">
                                    ...
                                    <h5><em>Bambu brings forth the founders' personal experiences
                                            during their journey of learning.</em></h5>
                                    <div class="separator_left"></div>
                                </div><!-- End off Head Title -->

                                <div class="feature_content wow fadeIn m-top-40">
                                    <p>We source for products that we truly believe will enable educators, students and 
                                        working adults to teach, learn and process. What you see here are products that
                                        affordable, durable and efficient</p>

                                    <p>Join us in this journey of knowledge gathering.</p>
                            ...
                            <div class="col-md-6">
                                <div class="feature_photo wow fadeIn sm-m-top-40">
                                    ...
                                    <div class="feature_img">
                                        <img src="https://i.ibb.co/KzCS3b4/feature-img.jpg" alt="feature-img" border="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12 text-right pull-right sm-text-center">
                                            <div class="work_item_img">
                                                <img src="https://i.ibb.co/x5jWN8G/i01-work-img1.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-sm-12 col-xs-12 text-right pull-left sm-text-center">
                                            <div class="work_item_details m-top-80 sm-m-top-20">
                                                <h4>Electronic Blackboards</h4>
                                                <div class="work_separator1"></div>
                                                <p class="m-top-40 sm-m-top-10">An electronic notepad/blackboard is a digital device that 
                                                allows users to write, draw, and create with a stylus or touch input. It provides a versatile 
                                                and paperless platform for note-taking, brainstorming, and interactive presentations.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12">
                                            <div class="work_item_img sm-text-center sm-m-top-40">
                                                <img src="https://i.ibb.co/VYGQV3Q/i01-oip.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-sm-12 col-xs-12 text-left pull-left sm-text-center">
                                            <div class="work_item_details m-top-80 sm-m-top-20">
                                                ...
                                                <p class="m-top-40 sm-m-top-10">An electronic tablet is a portable, touchscreen device, offering versatile functionality for web browsing, 
                                                    entertainment, and productivity tasks, with a user-friendly interface and broad appeal.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12 text-right pull-right sm-text-center">
                                            <div class="work_item_img sm-m-top-40">
                                                <img src="https://i.ibb.co/qp03sRK/i01-huion-wireless-graphics-drawing-tablet.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-sm-12 col-xs-12 text-right pull-left sm-text-center">
                                            <div class="work_item_details m-top-80 sm-m-top-20">
                                                ...
                                                <div class="work_separator1"></div>
                                                <p class="m-top-40 sm-m-top-10">A drawing tablet is an artist's input device with a flat surface and stylus, enabling direct digital drawing on a computer. 
                                                    Ideal for precise and natural art creation and graphic design.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="work_item">
                                    <div class="row">
                                        <div class="col-md-7 col-sm-12 col-xs-12">
                                            <div class="work_item_img sm-text-center sm-m-top-40">
                                                <img src="https://i.ibb.co/hmqLy5Y/i01-glossy-apple-pencil-3-reportedly-on-its-way-532692-2.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-5 col-sm-12 col-xs-12 text-left pull-left sm-text-center">
                                            <div class="work_item_details m-top-80 sm-m-top-20">
                                                <h4>Accessories</h4>
                                                <div class="work_separator2"></div>
                                                <p class="m-top-40 sm-m-top-10">Accessories for tablets or iPads include protective cases, stylus pens, screen protectors, external keyboards, stands, and charging docks. 
                                                    These add-ons enhance functionality, aesthetics, and durability, catering to diverse user needs.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="service_content_area">
                            ...
                            <div class="col-md-4 service_left wow fadeInLeft">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="text-left service_left_text">
                                                <h4 class="main-color">Superbly Responsive</h4>
                                                <p>We prioritize customer needs and respond promptly for an exceptional experience.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="text-left service_left_text">
                                                ...
                                                <p>Our tablets boast a distinct, one-of-a-kind design, setting them apart from the rest.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="service_items">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="text-left service_left_text">
                                                <h4 class="main-color">Repair Services</h4>
                                                <p>We provide tablet repair services to ensure your device stays in optimal condition.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 sm-m-top-40 sm-text-center">
                                <div class="service-img wow bounceIn">
                                    <img src="https://i.ibb.co/kBK5VR9/i01-student.png" alt="Student Img">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 service_right wow fadeInRight sm-m-top-40" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="service_right_text p-l-15 text-right">
                                                <h4 class="main-color">Fast Delivery</h4>
                                                <p>We cut repair time to offer swift solutions for our tablets, ensuring prompt service.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="service_items">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="service_right_text p-l-15 text-right">
                                                <h4 class="main-color">Latest Gadgets</h4>
                                                <p>Our announcements on the latest tablets will outpace competitors, delivering new tablets faster and more efficiently.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="service_right_text p-l-15 text-right">
                                                ...
                                                <p>DStay updated on the latest news, join our Telegram group for timely and exclusive updates.</p>
                                            </div>
                                        </div>
                        ...
                        <div class="main-gallery roomy-80">
                            <div class="col-md-12">
                                <div class="head_title text-left sm-text-center wow fadeInDown">
                                    ...
                                    <h5><em>New & On Sale Products. Discover them now!</em></h5>
                                    <div class="separator_left"></div>
                                </div>
                            </div>
                            <div class="col-md-12 m-bottom-60">
                                <div class="filters-button-group text-right sm-text-center">
                                    ...
                                    <button class="button" data-filter=".metal">On Promotion</button>
                                    <button class="button" data-filter=".transition">New Products</button>
                                    <button class="button" data-filter=".alkali">Best Sellers</button>
                                    <button class="button" data-filter=".ar">Personal Favorites</button>
                                </div>
                            </div>
                            ...
                            <div class="grid text-center">
                                <div class="grid-item transition metal ium">
                                    <img alt="" src="https://i.ibb.co/dmP5v02/i01-kobo.jpg">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-110">
                                            <h4 class="text-white">Rakuten</h4>
                                            <h5 class="text-white"><em>Kobo Libra 2</em></h5>
                                            <a href="https://i.ibb.co/dmP5v02/i01-kobo.jpg" class="popup-img text-white m-top-40">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->

                                <div class="grid-item metalloid " >
                                    <img alt="" src="https://i.ibb.co/QccPNyw/i01-koboclara.jpg">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-150">
                                            <h4 class="text-white">Kobo</h4>
                                            <h5 class="text-white"><em>Clara HD</em></h5>
                                            <a href="https://i.ibb.co/QccPNyw/i01-koboclara.jpg" class="popup-img text-white m-top-50">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->

                                <div class="grid-item post-transition metal numberGreaterThan50">
                                    <img alt="" src="https://i.ibb.co/nrYMwLw/i01-kindle.jpg">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-50">
                                            <h4 class="text-white">Amazon</h4>
                                            <h5 class="text-white"><em>Paperwhite Signature</em></h5>
                                            <a href="https://i.ibb.co/nrYMwLw/i01-kindle.jpg" class="popup-img text-white m-top-40">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->
                                
                                <div class="grid-item alkali ar" >
                                    <img alt="" src="https://i.ibb.co/BwmBDmV/i01-kindleoasis.jpg">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-50">
                                            <h4 class="text-white">Amazon</h4>
                                            <h5 class="text-white"><em>Paperwhite Signature</em></h5>
                                            <a href="https://i.ibb.co/BwmBDmV/i01-kindleoasis.jpg" class="popup-img text-white m-top-40">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->

                                <div class="grid-item post-transition metal ium" >
                                    <img alt="" src="https://i.ibb.co/QmVVHym/i01-pocketbook.jpg">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-150">
                                            <h4 class="text-white">Pocketbook</h4>
                                            <h5 class="text-white"><em>PocketBook InkPad Lite</em></h5>
                                            <a href="https://i.ibb.co/QmVVHym/i01-pocketbook.jpg" class="popup-img text-white m-top-50">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->
                                ...
                                <div class="grid-item metal ar" >
                                    <img alt="" src="https://i.ibb.co/HY1610W/i01-bigme.jpg" alt="i01-bigme">
                                    <div class="grid_hover_area text-center">
                                        <div class="grid_hover_text m-top-110">
                                            <h4 class="text-white">Bigme</h4>
                                            <h5 class="text-white"><em>Bigme S6 Color + Ereader 6GB</em></h5>
                                            <a href="https://i.ibb.co/HY1610W/i01-bigme.jpg" class="popup-img text-white m-top-40">View Products <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div><!-- End off grid Hover area -->
                                </div><!-- End off grid item -->
            ...
            <div class="row">
                <div class="main_contact p-top-100">
                    <div class="col-md-6 sm-m-top-30">
                        <form class="" action="process_form.php" method="post" onsubmit="return validateContactForm()">
                            <div class="row">
                                <div class="col-sm-6">
